...
const TRANSLATIONS = {
    ar: {
        ...
        aiLoading: '<i class="fa-solid fa-circle-notch fa-spin"></i> جاري التوليد والتنظيم الذكي بواسطة Llama 3.1...',
    ...
    en: {
        ...
        aiLoading: '<i class="fa-solid fa-circle-notch fa-spin"></i> Generating smart mind map via Llama 3.1...',
